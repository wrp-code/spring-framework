...
final class PostProcessorRegistrationDelegate {
	...
	public static void registerBeanPostProcessors(
		...
		// Ordered, and the rest.
		// 指定优先级的BeanPostProcessor:实现org.springframework.core.PriorityOrdered接口的BeanPostProcessor，但是不包含MergedBeanDefinitionPostProcessor类型的
		List<BeanPostProcessor> priorityOrderedPostProcessors = new ArrayList<>();
		// 指定了顺序的BeanPostProcessor:标注有@Order注解，或者实现了org.springframework.core.annotation.Order接口的BeanPostProcessor，但是不包含MergedBeanDefinitionPostProcessor类型的
		List<String> orderedPostProcessorNames = new ArrayList<>();
		// 未指定顺序的BeanPostProcessor: 上面2中类型之外以及MergedBeanDefinitionPostProcessor之外的
		List<String> nonOrderedPostProcessorNames = new ArrayList<>();
